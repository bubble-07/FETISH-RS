...
pub const FUNC_OPTIMUM_OUT_COVARIANCE_MULTIPLIER : f32 = 2.0f32;
//Should be pretty small, to reflect how little we know about the trend
pub const FUNC_OPTIMUM_IN_PRECISION_MULTIPLIER : f32 = 0.5f32;

//Priors for elaborator
//
pub const ELABORATOR_ERROR_COVARIANCE_PRIOR_OBSERVATIONS_PER_DIMENSION : f32 = 10.0f32;
//Should be pretty big (since we don't believe the subspace will necessarily be consistent)
pub const ELABORATOR_OUT_COVARIANCE_MULTIPLIER : f32 = 2.0f32;
//Should be pretty small (since we have no idea what the map should look like)
pub const ELABORATOR_IN_PRECISION_MULTIPLIER : f32 = 0.5f32;

//Priors for term models
//
//Should be pretty small (since we believe that there will be little model misspecification)
pub const TERM_MODEL_OUT_COVARIANCE_MULTIPLIER : f32 = 2.0f32;
